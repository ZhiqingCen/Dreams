'''
http test file for src/message_react_v1
'''
import requests
import json
...
def test_message_react_empty_token():
    ...
    resp = requests.post(url + 'message/react/v1', json = {'token': '', 'message_id': message1['message_id'], 'react_id': 1})
...
def test_message_react_none_token():
    ...
    message1 = requests.post(url + 'message/send/v2', json = {'token': user_one['token'], 'channel_id': channel1['channel_id'], 'message': 'message'})
    message1 = json.loads(message1.text)
    resp = requests.post(url + 'message/react/v1', json = {'token': None, 'message_id': message1['message_id'], 'react_id': 1})
    assert resp.status_code == ACCESS_ERROR
...
def test_message_react_invalid_token_type():
    ...
    message1 = requests.post(url + 'message/send/v2', json = {'token': user_one['token'], 'channel_id': channel1['channel_id'], 'message': 'message'})
    message1 = json.loads(message1.text)
    resp = requests.post(url + 'message/react/v1', json = {'token': 123456789, 'message_id': message1['message_id'], 'react_id': 1})
    assert resp.status_code == ACCESS_ERROR
...
def test_message_react_token_not_exist():
    ...
    message1 = requests.post(url + 'message/send/v2', json = {'token': user_one['token'], 'channel_id': channel1['channel_id'], 'message': 'message'})
    message1 = json.loads(message1.text)
    resp = requests.post(url + 'message/react/v1', json = {'token': 'invalid_token', 'message_id': message1['message_id'], 'react_id': 1})
    assert resp.status_code == ACCESS_ERROR
...
def test_message_react_none_message_id():
    ...
    user1 = requests.post(url + 'auth/register/v2', json = one)
    user_one = json.loads(user1.text)
    resp = requests.post(url + 'message/react/v1', json = {'token': user_one['token'], 'message_id': None, 'react_id': 1})
...
def test_message_react_invalid_message_id_type():
    ...
    user1 = requests.post(url + 'auth/register/v2', json = one)
    user_one = json.loads(user1.text)
    resp = requests.post(url + 'message/react/v1', json = {'token': user_one['token'], 'message_id': 'invalid_message_id', 'react_id': 1})
    assert resp.status_code == INPUT_ERROR
...
def test_message_react_message_id_not_exist():
    ...
    user1 = requests.post(url + 'auth/register/v2', json = one)
    user_one = json.loads(user1.text)
    resp = requests.post(url + 'message/react/v1', json = {'token': user_one['token'], 'message_id': 123456789, 'react_id': 1})
    assert resp.status_code == INPUT_ERROR
...
def test_message_react_none_react_id():
    ...
    message1 = requests.post(url + 'message/send/v2', json = {'token': user_one['token'], 'channel_id': channel1['channel_id'], 'message': 'message'})
    message1 = json.loads(message1.text)
    resp = requests.post(url + 'message/react/v1', json = {'token': user_one['token'], 'message_id': message1['message_id'], 'react_id': None})
    assert resp.status_code == INPUT_ERROR
...
def test_message_react_invalid_react_id_type():
    ...
    message1 = requests.post(url + 'message/send/v2', json = {'token': user_one['token'], 'channel_id': channel1['channel_id'], 'message': 'message'})
    message1 = json.loads(message1.text)
    resp = requests.post(url + 'message/react/v1', json = {'token': user_one['token'], 'message_id': message1['message_id'], 'react_id': 'invalid_react_id'})
    assert resp.status_code == INPUT_ERROR
...
def test_message_react_react_id_not_exist():
    ...
    message1 = requests.post(url + 'message/send/v2', json = {'token': user_one['token'], 'channel_id': channel1['channel_id'], 'message': 'message'})
    message1 = json.loads(message1.text)
    resp = requests.post(url + 'message/react/v1', json = {'token': user_one['token'], 'message_id': message1['message_id'], 'react_id': 2})
    assert resp.status_code == INPUT_ERROR
...
def test_message_react_not_channel_member():
    ...
    message1 = requests.post(url + 'message/send/v2', json = {'token': user_one['token'], 'channel_id': channel1['channel_id'], 'message': 'message'})
    message1 = json.loads(message1.text)
    resp = requests.post(url + 'message/react/v1', json = {'token': user_two['token'], 'message_id': message1['message_id'], 'react_id': 1})
    assert resp.status_code == ACCESS_ERROR
...
def test_message_react_not_dm_member():
    ...
    resp = requests.post(url + 'message/react/v1', json = {'token': user_three['token'], 'message_id': dm_message['message_id'], 'react_id': 1})
    assert resp.status_code == ACCESS_ERROR
...
def test_message_react_dm_message():
    ...
    dm_message = requests.post(url + 'message/senddm/v1', json = {'token': user_two['token'], 'dm_id': dm['dm_id'], 'message': 'message'})
    dm_message = dm_message.json()
    resp = requests.post(url + 'message/react/v1', json = {'token': user_two['token'], 'message_id': dm_message['message_id'], 'react_id': 1})
    assert resp.status_code == OK
    resp = json.loads(resp.text)
    assert resp == {}
